...
const Receive = () => {
    useEffect(() => {
        ...
        function addMessage(msg) {
            ...
            message.innerHTML =
                '<br><span className="msg-time">' + h + ':' + m + ':' + s + '</span>  -  ' + msg + message.innerHTML;
        }
        ...
        sendButton.addEventListener('click', function () {
            if (conn && conn.open) {
                ...
                addMessage('<span className="selfMsg">Self: </span>' + msg);
            } else {
    ...
    return (
        <>
            <table className="display">
                ...
                <tr>
                    <td>
                        <div id="receiver-id" title="Copy this ID to the input on send.html.">
                            ID:
                        </div>
                    </td>
                    <td>
